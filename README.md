...
telemetry model-driven
 ...
 sensor-group SG1MINS_COUNTERS
  sensor-path Cisco-IOS-XR-l2vpn-oper:l2vpnv2/nodes/node/bridge-domains/bridge-domain[bridge-domain-name="v1401"]/bridge-acs/bridge-ac[interface-name="Bundle-Ether1.1401"]/attachment-circuit/statistics
 ...
 subscription SUB1MINS_OPTICS
  sensor-group-id SG1MINS_OPTICS sample-interval 60000
  destination-id PIPELINE1
  source-interface Loopback0
 !        
 subscription SUB1MINS_GENERAL
  sensor-group-id SG1MINS_GENERAL sample-interval 60000
  destination-id PIPELINE1
  source-interface Loopback0
 !
 subscription SUB1MINS_COUNTERS
  sensor-group-id SG1MINS_COUNTERS sample-interval 60000
  destination-id PIPELINE1
  source-interface Loopback0
 !
 ```
